...
/**
 * Sim logo with icon and "NocoBuilder" text for OG image.
 */
  ...
  return (
    <svg height='28' viewBox='720 440 1020 320' fill='none'>
      ...
      <path
        ...
        fill='#33C482'
      />
      {/* "NocoBuilder" text - white for dark background */}
      <path
...
export async function GET(request: NextRequest) {
  ...
  const allText = `${title}docs.nocobuilder.cloud`
