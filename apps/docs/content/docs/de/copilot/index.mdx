...
<Callout type="info">
  Copilot ist ein von Sim verwalteter Dienst. Für selbst gehostete Installationen generiere einen Copilot API-Schlüssel in der gehosteten App (nocobuilder.cloud → Einstellungen → Copilot)
  1. Gehe zu [nocobuilder.cloud](https://nocobuilder.cloud) → Einstellungen → Copilot und generiere einen Copilot API-Schlüssel
...
1. Gehen Sie zu [nocobuilder.cloud](https://nocobuilder.cloud) und melden Sie sich an
...
<Callout type="info">
  Für selbst gehostete Deployments ersetzen Sie `https://www.nocobuilder.cloud` durch Ihre selbst gehostete Sim-URL.
</Callout>
