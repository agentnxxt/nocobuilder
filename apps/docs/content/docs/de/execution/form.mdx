...
- Per Direktlink geteilt werden kann (z. B. `https://nocobuilder.cloud/form/my-survey`)
...
3. Konfigurieren Sie:
   - **URL**: Eindeutige Kennung (z. B. `contact-form` → `nocobuilder.cloud/form/contact-form`)
...
**Formular lädt nicht im Iframe** - Überprüfen Sie, ob die CSP Ihrer Website Iframes von `nocobuilder.cloud` erlaubt.
