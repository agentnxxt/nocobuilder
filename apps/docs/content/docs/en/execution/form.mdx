...
- Shared via a direct link (e.g., `https://nocobuilder.cloud/form/my-survey`)
...
3. Configure:
   - **URL**: Unique identifier (e.g., `contact-form` → `nocobuilder.cloud/form/contact-form`)
   - **Title**: Form heading
...
**Form not loading in iframe** - Check your site's CSP allows iframes from `nocobuilder.cloud`.
