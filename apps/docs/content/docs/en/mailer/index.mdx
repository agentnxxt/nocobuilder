...
3. Optionally choose a custom address prefix (e.g., `acme` → `acme@mothership.nocobuilder.cloud`)
...
<FAQ items={[
  { question: "Can I use my own email domain?", answer: "Not currently. All inbox addresses use the @mothership.nocobuilder.cloud domain. You can customize the prefix (e.g., acme@mothership.nocobuilder.cloud) but not the domain itself." },
