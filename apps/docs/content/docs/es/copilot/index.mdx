...
<Callout type="info">
  Copilot es un servicio gestionado por Sim. Para implementaciones autoalojadas, genera una clave API de Copilot en la aplicación alojada (nocobuilder.cloud → Configuración → Copilot)
  1. Ve a [nocobuilder.cloud](https://nocobuilder.cloud) → Configuración → Copilot y genera una clave API de Copilot
...
1. Ve a [nocobuilder.cloud](https://nocobuilder.cloud) e inicia sesión
...
<Callout type="info">
  Para implementaciones auto-alojadas, reemplaza `https://www.nocobuilder.cloud` con tu URL de Sim auto-alojada.
</Callout>
