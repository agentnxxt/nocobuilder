...
- Compartido mediante un enlace directo (ej., `https://nocobuilder.cloud/form/my-survey`)
...
3. Configura:
   - **URL**: Identificador único (ej., `contact-form` → `nocobuilder.cloud/form/contact-form`)
...
**El formulario no se carga en el iframe** - Verifica que el CSP de tu sitio permita iframes desde `nocobuilder.cloud`.
