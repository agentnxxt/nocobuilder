...
kubectl port-forward deployment/sim-sim-app 3000:3000 -n nocobuilder

# View logs
kubectl logs -l app.kubernetes.io/component=app -n nocobuilder --tail=100

# Upgrade
helm upgrade sim ./helm/sim --namespace nocobuilder

# Uninstall
helm uninstall sim --namespace nocobuilder
```
