...
<Callout type="info">
  Copilot est un service géré par Sim. Pour les déploiements auto-hébergés, générez une clé API Copilot dans l'application hébergée (nocobuilder.cloud → Paramètres → Copilot)
  1. Allez sur [nocobuilder.cloud](https://nocobuilder.cloud) → Paramètres → Copilot et générez une clé API Copilot
...
1. Rendez-vous sur [nocobuilder.cloud](https://nocobuilder.cloud) et connectez-vous
...
<Callout type="info">
  Pour les déploiements auto-hébergés, remplacez `https://www.nocobuilder.cloud` par votre URL Sim auto-hébergée.
</Callout>
