...
<Callout type="info">
  Copilot 是一个由 Sim 管理的服务。对于自托管部署，请在托管应用程序中生成一个 Copilot API 密钥（nocobuilder.cloud → 设置 → Copilot）
  1. 前往 [nocobuilder.cloud](https://nocobuilder.cloud) → 设置 → Copilot 并生成一个 Copilot API 密钥
...
1. 访问 [nocobuilder.cloud](https://nocobuilder.cloud) 并登录
2. 进入 **设置** → **Copilot**
3. 点击 **生成 API 密钥**
4. 复制密钥 — 该密钥只显示一次
...
<Callout type="info">
  对于自托管部署，请将 `https://www.nocobuilder.cloud` 替换为你的自托管 Sim URL。
</Callout>
