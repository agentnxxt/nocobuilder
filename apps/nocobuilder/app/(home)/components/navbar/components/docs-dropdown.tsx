...
const PREVIEW_CARDS = [
  {
    title: 'Introduction',
    href: 'https://docs.nocobuilder.cloud',
    image: '/landing/docs-getting-started.svg',
  },
  {
    title: 'Getting Started',
    href: 'https://docs.nocobuilder.cloud/getting-started',
...
const RESOURCE_CARDS = [
  {
    ...
    href: 'https://docs.nocobuilder.cloud/blocks/agent',
    icon: AgentIcon,
  },
  {
    title: 'MCP',
    description: 'Connect tools',
    href: 'https://docs.nocobuilder.cloud/mcp',
    icon: McpIcon,
  },
  {
    title: 'Self-hosting',
    description: 'Host on your infra',
    href: 'https://docs.nocobuilder.cloud/self-hosting',
