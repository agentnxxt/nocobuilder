    ...
    '@graph': [
      {
        ...
        logo: {
          ...
          url: 'https://nocobuilder.cloud/logo/b%26w/text/b%26w.svg',
          contentUrl: 'https://nocobuilder.cloud/logo/b%26w/text/b%26w.svg',
          width: 49.78314,
          height: 24.276,
          caption: 'Sim Logo',
        },
      ...
      },
      {
        ...
        publisher: { '@id': 'https://nocobuilder.cloud/#organization' },
        inLanguage: 'en-US',
      },
      {
        '@type': 'WebPage',
        ...
        url: 'https://nocobuilder.cloud',
        name: 'Sim — Build AI Agents & Run Your Agentic Workforce',
        isPartOf: { '@id': 'https://nocobuilder.cloud/#website' },
        about: { '@id': 'https://nocobuilder.cloud/#software' },
        ...
        breadcrumb: { '@id': 'https://nocobuilder.cloud/#breadcrumb' },
        inLanguage: 'en-US',
        speakable: {
          '@type': 'SpeakableSpecification',
          cssSelector: ['#hero-heading', '[id="hero"] p'],
        },
        potentialAction: [{ '@type': 'ReadAction', target: ['https://nocobuilder.cloud'] }],
      },
      {
        '@type': 'BreadcrumbList',
