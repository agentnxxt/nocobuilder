        ...
        <div className={`flex gap-[80px] ${fullWidth ? 'justify-center' : ''}`}>
          ...
          <div>
            ...
            <div className='flex flex-col gap-[12px]'>
              ...
              <Link
                href='https://status.nocobuilder.cloud'
                target='_blank'
                rel='noopener noreferrer'
                className='text-[14px] text-muted-foreground transition-colors hover:text-foreground'
              >
          ...
          <div className='hidden sm:block'>
            ...
            <div className='flex flex-col gap-[12px]'>
              {FOOTER_BLOCKS.map((block) => (
                <Link
                  key={block}
                  href={`https://docs.nocobuilder.cloud/blocks/${block.toLowerCase().replaceAll(' ', '-')}`}
                  target='_blank'
                  rel='noopener noreferrer'
                  className='text-[14px] text-muted-foreground transition-colors hover:text-foreground'
                >
            ...
            <div className='flex gap-[80px]'>
              ...
              <div className='flex flex-col gap-[12px]'>
                {FOOTER_TOOLS.slice(0, Math.ceil(FOOTER_TOOLS.length / 4)).map((tool) => (
                  <Link
                    key={tool}
                    href={`https://docs.nocobuilder.cloud/tools/${tool.toLowerCase().replace(/\s+/g, '_')}`}
                    target='_blank'
                    rel='noopener noreferrer'
