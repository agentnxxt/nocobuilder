...
function buildFAQs(integration: Integration): FAQItem[] {
  ...
  const faqs: FAQItem[] = [
    ...
    },
    {
      ...
      answer: `Getting started takes under five minutes: (1) Create a free account at nocobuilder.cloud. (2) Open a new workflow. (3) Drag a ${name} block onto the canvas. (4) ${authStep} (5) Choose the tool you want to use, wire it to the inputs you need, and click Run. Your automation is live.`,
    },
    {
    ...
    },
    {
      ...
      answer: `Yes — Sim's free plan includes access to the ${name} integration and every other integration in the library. No credit card is needed to get started. Visit nocobuilder.cloud to create your account.`,
    },
  ]
...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      url: `https://nocobuilder.cloud/integrations/${slug}`,
      type: 'website',
      images: [{ url: 'https://nocobuilder.cloud/opengraph-image.png', width: 1200, height: 630 }],
    },
    twitter: {
    ...
    alternates: { canonical: `https://nocobuilder.cloud/integrations/${slug}` },
  }
}
...
export default async function IntegrationPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const breadcrumbJsonLd = {
    ...
    '@type': 'BreadcrumbList',
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://nocobuilder.cloud' },
      {
        '@type': 'ListItem',
        position: 2,
        name: 'Integrations',
        item: 'https://nocobuilder.cloud/integrations',
      },
      { '@type': 'ListItem', position: 3, name, item: `https://nocobuilder.cloud/integrations/${slug}` },
    ],
  }
    ...
    step: [
      {
        ...
        text: 'Sign up at nocobuilder.cloud — no credit card required.',
      },
      {
        '@type': 'HowToStep',
        position: 2,
                ...
                {[
                  {
                    ...
                    body: 'Sign up at nocobuilder.cloud in seconds. No credit card required. Your workspace is ready immediately.',
                  },
                  {
                    step: '02',
