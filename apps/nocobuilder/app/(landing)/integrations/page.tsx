...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://nocobuilder.cloud/integrations',
    type: 'website',
  ...
  alternates: { canonical: 'https://nocobuilder.cloud/integrations' },
}
  ...
  const itemListJsonLd = {
    ...
    itemListElement: allIntegrations.map((integration, index) => ({
      ...
      item: {
        ...
        url: `https://nocobuilder.cloud/integrations/${integration.slug}`,
