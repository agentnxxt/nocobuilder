    ...
    <LegalLayout title='Privacy Policy'>
      ...
      <section>
        ...
        <ul className='mb-4 list-disc space-y-2 pl-6'>
          ...
          <li>
            <strong>Website</strong> refers to Sim, accessible from nocobuilder.cloud
          </li>
          <li>
      ...
      <section>
        ...
        <p className='mb-4'>
          ...
          <Link href='mailto:privacy@nocobuilder.cloud' className='text-[#ECECEC] underline hover:text-white'>
            privacy@nocobuilder.cloud
          </Link>
          .
        </p>
      ...
      <section>
        ...
        <ul className='mb-4 list-disc space-y-2 pl-6'>
          <li>nocobuilder.cloud website</li>
        ...
        <p className='mb-4'>
          ...
          inquiry, email us at{' '}
          <Link href='mailto:security@nocobuilder.cloud' className='text-[#ECECEC] underline hover:text-white'>
            security@nocobuilder.cloud
          </Link>{' '}
      ...
      <section>
        ...
        <ul className='mb-4 list-disc space-y-2 pl-6'>
          <li>
            Email:{' '}
            <Link
              href='mailto:privacy@nocobuilder.cloud'
