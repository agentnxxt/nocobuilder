    ...
    <LegalLayout title='Terms of Service'>
      ...
      <section>
        ...
        <p className='mb-4'>
          ...
          <Link href='mailto:legal@nocobuilder.cloud' className='text-[#ECECEC] underline hover:text-white'>
            legal@nocobuilder.cloud{' '}
          </Link>
      ...
      <section>
        ...
        <p>
          ...
          <Link
            href='mailto:copyright@nocobuilder.cloud'
            className='text-[#ECECEC] underline hover:text-white'
          >
            copyright@nocobuilder.cloud
          </Link>
        </p>
      </section>
