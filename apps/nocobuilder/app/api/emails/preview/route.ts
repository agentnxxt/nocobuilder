...
const emailTemplates = {
  ...
  'reset-password': () => renderPasswordResetEmail('John', 'https://nocobuilder.cloud/reset?token=abc123'),
  welcome: () => renderWelcomeEmail('John'),

  // Invitation emails
  invitation: () => renderInvitationEmail('Jane Doe', 'Acme Corp', 'https://nocobuilder.cloud/invite/abc123'),
  'batch-invitation': () =>
    renderBatchInvitationEmail(
      'Jane Doe',
      'Acme Corp',
      ...
      'https://nocobuilder.cloud/invite/abc123'
    ),
  'workspace-invitation': () =>
    renderWorkspaceInvitationEmail(
      'John Smith',
      'Engineering Team',
      'https://nocobuilder.cloud/workspace/invite/abc123'
    ),
  ...
  'usage-threshold': () =>
    renderUsageThresholdEmail({
      ...
      currentUsage: 15,
      limit: 20,
      ctaLink: 'https://nocobuilder.cloud/settings/billing',
    }),
  ...
  'free-tier-upgrade': () =>
    renderFreeTierUpgradeEmail({
      ...
      currentUsage: 9,
      limit: 10,
      upgradeLink: 'https://nocobuilder.cloud/settings/billing',
    }),
  'plan-welcome-pro': () =>
    renderPlanWelcomeEmail({
      planName: 'Pro',
      userName: 'John',
      loginLink: 'https://nocobuilder.cloud/login',
    }),
  'plan-welcome-team': () =>
    renderPlanWelcomeEmail({
      planName: 'Team',
  ...
  'payment-failed': () =>
    renderPaymentFailedEmail({
      ...
      amountDue: 20,
      lastFourDigits: '4242',
      billingPortalUrl: 'https://nocobuilder.cloud/settings/billing',
  ...
  'workflow-notification-success': () =>
    renderWorkflowNotificationEmail({
      ...
      duration: '2.3s',
      cost: '$0.0042',
      logUrl: 'https://nocobuilder.cloud/workspace/ws_123/logs?search=exec_abc123',
    }),
