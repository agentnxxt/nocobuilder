...
timeRequired: PT10M
canonical: https://nocobuilder.cloud/blog/enterprise
featured: true
draft: false
---
...
- **[Knowledge Base](https://docs.nocobuilder.cloud/blocks/knowledge)** — Disable document uploads if RAG workflows aren't approved
- **[MCP Tools](https://docs.nocobuilder.cloud/mcp)** — Block deployment of workflows as external tool endpoints
...
Run Sim entirely on your infrastructure. Deploy with [Docker Compose](https://docs.nocobuilder.cloud/self-hosting/docker) or [Helm charts](https://docs.nocobuilder.cloud/self-hosting/kubernetes) for Kubernetes—the application, WebSocket server, and PostgreSQL database all stay within your network.
...
**Air-gapped** — No external network access required. Pair with [Ollama](https://docs.nocobuilder.cloud/self-hosting/ollama) or [vLLM](https://docs.nocobuilder.cloud/self-hosting/vllm) for local model inference.
...
Enterprise features are available now. Check out our [self-hosting](https://docs.nocobuilder.cloud/self-hosting) and [enterprise](https://docs.nocobuilder.cloud/enterprise) docs to get started.
