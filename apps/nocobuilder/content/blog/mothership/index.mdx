...
timeRequired: PT10M
canonical: https://nocobuilder.cloud/blog/mothership
featured: true
draft: false
---
...
Sim v0.6 is available now at [nocobuilder.cloud](https://nocobuilder.cloud). Check out our [documentation](https://docs.nocobuilder.cloud) for detailed guides on Mothership, Tables, Connectors, and more.

*Questions? [help@nocobuilder.cloud](mailto:help@nocobuilder.cloud) · [Discord](https://nocobuilder.cloud/discord)*
