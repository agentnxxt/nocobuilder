...
timeRequired: PT8M
canonical: https://nocobuilder.cloud/blog/v0-5
featured: true
draft: false
---
...
Available now at [nocobuilder.cloud](https://nocobuilder.cloud). Check out the [docs](https://docs.nocobuilder.cloud) to dive deeper.
