...
export function buildArticleJsonLd(post: BlogMeta) {
  return {
    ...
    publisher: {
      ...
      logo: {
        '@type': 'ImageObject',
        url: 'https://nocobuilder.cloud/logo/primary/medium.png',
      },
    },
    mainEntityOfPage: {
      '@type': 'WebPage',
...
export function buildBreadcrumbJsonLd(post: BlogMeta) {
  return {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Blog', item: 'https://nocobuilder.cloud/blog' },
...
export function buildBlogJsonLd() {
  return {
    ...
    '@type': 'Blog',
    name: 'Sim Blog',
    url: 'https://nocobuilder.cloud/blog',
