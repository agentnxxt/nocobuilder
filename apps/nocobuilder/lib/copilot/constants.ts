...
export const NOCO_AGENT_API_URL_DEFAULT = 'https://copilot.nocobuilder.cloud'
export const SIM_AGENT_VERSION = '3.0.0'

/** Resolved copilot backend URL — reads from env with fallback to default. */
const rawAgentUrl = env.NOCO_AGENT_API_URL || NOCO_AGENT_API_URL_DEFAULT
export const NOCO_AGENT_API_URL =
  rawAgentUrl.startsWith('http://') || rawAgentUrl.startsWith('https://')
    ? rawAgentUrl
    : NOCO_AGENT_API_URL_DEFAULT
