...
export const env = createEnv({
  ...
  server: {
    ...
    NOCO_AGENT_API_URL:                     z.string().url().optional(),            // URL for internal sim agent API
  ...
  client: {
    ...
    NEXT_PUBLIC_APP_URL:                   z.string().url(),                       // Base URL of the application (e.g., https://www.nocobuilder.cloud)
    ...
    NEXT_PUBLIC_BRAND_NAME:                z.string().optional(),                  // Custom brand name (defaults to "NocoBuilder")
