 ...
 * @returns The domain with port if applicable (e.g., 'localhost:3000' or 'nocobuilder.cloud')
 */
export function getBaseDomain(): string {
  try {
    ...
    try {
      ...
      return isProd ? 'nocobuilder.cloud' : 'localhost:3000'
    }
  }
}
 ...
 * @returns The email domain (e.g., 'nocobuilder.cloud' instead of 'www.nocobuilder.cloud')
 */
