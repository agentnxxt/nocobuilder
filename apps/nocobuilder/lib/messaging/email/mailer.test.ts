...
vi.mock('@/lib/core/config/env', () =>
  createEnvMock({
    ...
    FROM_EMAIL_ADDRESS: 'Sim <noreply@nocobuilder.cloud>',
  })
)

// Mock URL utilities
vi.mock('@/lib/core/utils/urls', () => ({
  getEmailDomain: vi.fn().mockReturnValue('nocobuilder.cloud'),
  getBaseUrl: vi.fn().mockReturnValue('https://test.nocobuilder.cloud'),
  getBaseDomain: vi.fn().mockReturnValue('test.nocobuilder.cloud'),
}))

// Mock the utils module (getFromEmailAddress)
vi.mock('@/lib/messaging/email/utils', () => ({
  getFromEmailAddress: vi.fn().mockReturnValue('Sim <noreply@nocobuilder.cloud>'),
}))
