 ...
 *
 * Usage:
 *   bun apps/nocobuilder/scripts/export-workflow.ts <workflow-id>
 *
...
if (!workflowId) {
  process.stderr.write(
    'Usage: bun apps/nocobuilder/scripts/export-workflow.ts <workflow-id> [output-file]\n'
  )
  process.stderr.write('\n')
  process.stderr.write('Examples:\n')
  process.stderr.write('  bun apps/nocobuilder/scripts/export-workflow.ts abc123\n')
  process.stderr.write('  bun apps/nocobuilder/scripts/export-workflow.ts abc123 workflow.json\n')
  process.stderr.write('\n')
