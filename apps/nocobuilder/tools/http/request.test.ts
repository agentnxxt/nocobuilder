...
describe('HTTP Request Tool', () => {
  ...
  beforeEach(() => {
    ...
    process.env.NEXT_PUBLIC_APP_URL = 'https://nocobuilder.cloud'
  })
  ...
  describe('Headers Construction', () => {
    ...
    it('should set dynamic Referer header correctly', async () => {
      ...
      Object.defineProperty(global, 'window', {
        value: {
          location: {
            origin: 'https://nocobuilder.cloud',
          },
        },
        writable: true,
      })
      ...
      expect(fetchCall[1].headers.Referer).toBe('https://nocobuilder.cloud')
  ...
  describe('Request Execution', () => {
    it('should apply default and dynamic headers to requests', async () => {
      ...
      expect(headers.Referer).toBe('https://nocobuilder.cloud')
