...
{{- /* Use global registry for nocobuilder images or when explicitly set for all images */ -}}
{{- if .context.Values.global.imageRegistry -}}
  {{- if or (hasPrefix "nocobuilder/" $repository) .context.Values.global.useRegistryForAllImages -}}
