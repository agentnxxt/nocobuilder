...
class NocoBuilderClient:
    """
    Sim API client for executing workflows programmatically.
    
    Args:
        api_key: Your Sim API key
        base_url: Base URL for the Sim API (defaults to https://nocobuilder.cloud)
    """
    
    def __init__(self, api_key: str, base_url: str = "https://nocobuilder.cloud"):
    ...
    def execute_workflow(
        ...
        *,
        ...
        Raises:
            NocoBuilderError: If the workflow execution fails
        """
        ...
        try:
            ...
            if not response.ok:
                ...
                raise NocoBuilderError(error_message, error_code, response.status_code)
            ...
            raise NocoBuilderError(f'Workflow execution timed out after {timeout} seconds', 'TIMEOUT')
        except requests.RequestException as e:
            raise NocoBuilderError(f'Failed to execute workflow: {str(e)}', 'EXECUTION_ERROR')
    ...
    def get_workflow_status(self, workflow_id: str) -> WorkflowStatus:
        ...
        Raises:
            NocoBuilderError: If getting the status fails
        """
        ...
        try:
            ...
            raise NocoBuilderError(f'Failed to get workflow status: {str(e)}', 'STATUS_ERROR')
    ...
    def get_job_status(self, task_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            raise NocoBuilderError(f'Failed to get job status: {str(e)}', 'STATUS_ERROR')
    ...
    def execute_with_retry(
        ...
        *,
        ...
        Raises:
            NocoBuilderError: If max retries exceeded or other error occurs
        """
        last_error = None
        delay = initial_delay
        ...
        raise last_error or NocoBuilderError('Max retries exceeded', 'MAX_RETRIES_EXCEEDED')
    ...
    def get_usage_limits(self) -> UsageLimits:
        ...
        Raises:
            NocoBuilderError: If getting usage limits fails
        """
        ...
        try:
            ...
            raise NocoBuilderError(f'Failed to get usage limits: {str(e)}', 'USAGE_ERROR')
